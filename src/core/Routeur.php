...
class Routeur
{
    ...
    protected $_routes = [ 
        ...
        'validate-update-by-member'  => ['controller' => 'App\Controller\ValidationGameController',         'method' => 'validateUpdateByMember'],
        'delete-update-by-member'    => ['controller' => 'App\Controller\ValidationGameController',         'method' => 'deleteUpdateByMember'],
