...
class Routeur
{
    ...
    protected $_routes = [ 
        ...
        'entity-management'    => ['controller' => 'App\Controller\DeveloperController',  'method' => 'showDevelopersManagement'],
        'add-developer'        => ['controller' => 'App\Controller\DeveloperController',  'method' => 'addDeveloper'],
