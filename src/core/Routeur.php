...
class Routeur
{
    ...
    protected $_routes = [ 
        ...
        'post'               => ['controller' => 'App\Controller\PostController',       'method' => 'showPost'],
        ...
        'add-post'           => ['controller' => 'App\Controller\PostController',       'method' => 'addPost'],
        'update-post'        => ['controller' => 'App\Controller\PostController',       'method' => 'updatePost'],
        'delete-post'        => ['controller' => 'App\Controller\PostController',       'method' => 'deletePostAndComments'],
        'post-management'    => ['controller' => 'App\Controller\BackController',       'method' => 'showPostsManagement'],
